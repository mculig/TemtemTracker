...
public class MenuBar extends JMenuBar {
	...
	public MenuBar(TemtemTableUI tableUI, UserSettings settings, Species species) {
		...
		JMenuItem openSaiparkSettings = new JMenuItem("Saipark Settings");
		openSaiparkSettings.addActionListener(new SaiparkSettingsWindow(tableUI, settings, species));
		
		settingsMenu.add(openSaiparkSettings);
